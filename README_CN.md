...
## 概述
**Albatross Android** 是一款专为安卓系统（Android 7.0 至 Android 16）设计的高性能、低影响的Hook与反射框架。
...
### 平台支持
- **安卓版本**：
  - 全面支持：API 26-34（8.0-16）
  - 指令Hook：API 24-34（7.0-16）
  - 字段访问：API 24-34（8.0-16），8.0以下因Dex优化限制，字段访问被禁用。
  - 方法Hook：API 24-25（7.0-7.1）

...
public class UnHookTest {
  ...
  static void test() throws AlbatrossErr, NoSuchMethodException {
    ...
    /*for (int i = 0; i < 2; i++)*/
    {
      ...
      Albatross.unhookMethod(FakeActivity.class.getDeclaredMethod("onResume"), A0.class.getDeclaredMethod("onResume"), A0.class.getDeclaredMethod("onResume$Backup"));
      count = Albatross.getMethodHookCount(A0.onResume.method);
      assert count == 0;
      ...
      assert Albatross.unhookMethod(FakeActivity.class.getDeclaredMethod("onResume"), A3.class.getDeclaredMethod("onResume"), A3.class.getDeclaredMethod("onResume"));
      assert !Albatross.unhookMethod(FakeActivity.class.getDeclaredMethod("onResume"), A3.class.getDeclaredMethod("onResume"), A3.class.getDeclaredMethod("onResume"));
      count = Albatross.getMethodHookCount(A0.onResume.method);
      assert count == 0;
      callSeq = 0;
